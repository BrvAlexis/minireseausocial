  ...
  <div className="max-w-8xl mx-auto flex flex-col px-6 py-20 lg:px-10 xl:px-24">
    ...
    <div className="mt-7 lg:flex lg:flex-row lg:justify-between">
      ...
      <div className="flex grow flex-row flex-wrap lg:flex-nowrap lg:items-start">
        {/* LINK BLOCK */}
        <div className="mb-5 mr-8 flex max-w-[300px] grow basis-[100px] flex-col space-y-5">
        ...
        <div className="mb-5 mr-8 flex max-w-[300px] grow basis-[100px] flex-col space-y-5">
          ...
          <a href="" className="font-inter font-light text-gray-500">Press</a>
          <a href="" className="font-inter font-light text-gray-500">Partners</a>
        </div>
      </div>
      {/* NEWSLETTER & EMAIL */}
      <div className="flex flex-col">
        <form action="" className="max-w-[421px]">
          <div className="relative">
            <label htmlFor="email" className="font-inter font-medium text-black">SUBSCRIBE TO NEWSLETTER</label>
            <div className="mt-4 flex flex-col md:flex-row">
              <input type="email" className="mr-6 block h-9 w-full border-black bg-[#f2f2f7] px-6 py-7 align-middle text-sm text-[#333333] focus:border-[#3898ec]" maxLength="256" name="email" placeholder="Enter your email" required="" />
              <input type="submit" value="Subscribe" className="mt-5 inline-block cursor-pointer bg-[#276ef1] px-6 py-3 text-center font-semibold text-white transition [box-shadow:rgb(171,_196,_245)_-8px_8px] hover:[box-shadow:rgb(171,_196,_245)_0px_0px] md:mt-0" />
            </div>
          </div>
        </form>

        <div>
          <h3 htmlFor="email" className="font-inter mb-4 mt-8 font-medium text-black">EMAIL US</h3>
    ...
    <div className="lg:flex lg:flex-row-reverse lg:justify-between">
      ...
      <div className="mb-8 mt-6 flex flex-row lg:mt-0">
        <a href="" className="mr-4 text-black transition hover:text-gray-400">
        ...
        <a href="" className="mx-4 text-black transition hover:text-gray-400">
          <svg className="fill-current" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="font-inter text-sm text-gray-500">© Copyright 2021. All rights reserved.</p>
    </div>
  </div>
</section>
